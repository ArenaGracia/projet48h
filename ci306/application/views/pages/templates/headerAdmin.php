                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="schedule.html">Modifier</a></li>
                            <li><a href="instructors.html">Lister les regimes</a></li>
                            <li><a href="message.html">Supprimer</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            <i class="bi bi-person"></i>

                            <span class="nav-text">Les Utilisateurs</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="instructor-dashboard.html">Voir la liste</a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <span class="nav-text">Aliments</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./create_aliment.html">Creer un autre</a></li>
                            <li><a href="./List_aliment.html">Lister</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="<?php echo site_url('welcomeAdmin/createCode') ?>">Creer un code</a></li>
                            <li><a href="<?php echo site_url('welcomeAdmin/listeCode') ?>">Lister</a></li>
                            <li><a href="<?php echo site_url('welcomeAdmin/toValidate') ?>">Validation</a></li>

                        </ul>
                    </li>
                    <li><a   href="<?php echo site_url('login/deconnectAdmin'); ?>" aria-expanded="false">
