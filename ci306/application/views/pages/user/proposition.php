      ...
      <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
          ...
          <li><a href="./../Login.html" aria-expanded="false">
              ...
              <span class="nav-text"><a class="small" style="color: #01703E;" href="<?php echo site_url('login/deconnectUser'); ?>">Deconnexion</a></span>
            </a>
        </ul>
      </div>
    </div>
                    ...
                    <table class="table table-responsive-md">
                      ...
                      <?php foreach($proposition as $propo) { ?>
                        <tr>
                          ...
                          <td><?php echo $propo['prix_total'] ?></td>
